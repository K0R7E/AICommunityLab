...
export function SiteHeader() {
  return (
    <header className="sticky top-0 z-50 border-b border-zinc-800/90 bg-[#0f0f0f]/90 pt-[env(safe-area-inset-top)] backdrop-blur-md">
      <div className="mx-auto flex h-14 max-w-[1400px] items-center justify-between gap-2 px-4 sm:gap-4 sm:px-6">
        ...
        <div className="flex max-w-[min(100%,20rem)] items-center justify-end gap-2">
          <Link
            href="/submit"
            className="inline-flex min-h-10 items-center gap-1.5 rounded-lg border border-zinc-700 bg-[#1a1a1a] px-2.5 py-2 text-xs font-medium text-zinc-200 transition hover:border-[#00ff9f]/45 lg:hidden"
          >
