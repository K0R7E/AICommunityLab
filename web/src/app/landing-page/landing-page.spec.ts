...
describe('LandingPage', () => {
  ...
  it('should render site header with logo', () => {
    ...
    const img = el.querySelector('.brand-logo') as HTMLImageElement | null;
  ...
  it('should render six tool cards with mock names', () => {
    fixture.detectChanges();
    ...
    expect(names[names.length - 1].nativeElement.textContent?.trim()).toBe('ImageCraft');
  });

  it('should toggle tool highlight when a tool slot is clicked', () => {
    fixture.detectChanges();
    const slot = fixture.nativeElement.querySelector('.tool-slot') as HTMLElement;
